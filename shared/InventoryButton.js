...
export class InventoryButton {
     ...
     */
    setItem(item) {
        if (!item) throw new Error(`[bombo] InventoryButton class: ${item} is not a valid item`)
     ...
     */
    setSlot(slot) {
        if (!slot) throw new Error(`[bombo] InventoryButton class: ${slot} is not a valid slot`)
     ...
     */
    setCommand(command) {
        if (!command) throw new Error(`[bombo] InventoryButton class: ${command} is not a valid command`)
    ...
    createItemByTexture(texture) {
        if (!texture) throw new Error(`[bombo] InventoryButton class: ${texture} is not a valid texture`)
     ...
     */
    onRightClick(fn) {
        if (typeof(fn) !== "function") throw new Error(`[bombo] InventoryButton class: ${fn} is not a valid function`)
