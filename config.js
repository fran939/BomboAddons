...
const applyChanges = (configInstance) => {
    ...
    FileLib.write("Bomboaddons", schemePath, JSON.stringify(scheme, null, 4))
...
const config = new DefaultConfig("Bomboaddons", "data/settings.json")
.addSwitch({
    category: "Dungeons",
...
.addButton({
    ...
    description: "Sends the tutorial for recording your own solutions to your chat &c(you can also just /bombo wb tutorial)",
    subcategory: "Dungeons",
    onClick() {
        ChatLib.command("bombo wb tutorial", true)
...
.addSwitch({
    ...
    description: "Allows you to make inventory buttons that can run specific commands. customize them with: &a/bombo invbtn",
    subcategory: "Misc"
})
.addSwitch({
    category: "Misc",
...
.addSwitch({
    ...
    description: "Renders a text and waypoint where the buttons should be clicked &b/bombo rsbtn &ato reset the clicked button list",
    subcategory: "Rift"
})
.addSwitch({
    category: "Rift",
...
.addTextParagraph({
    ...
    title: "Creator: bomboclas",
    description: "wish bomboclat",
    centered: true
})
.addButton({
    category: "General",
    configName: "skycrypt",
    title: "skyc",
    description: "sky shiiyu",
    subcategory: "General",
    onClick() {
        java.awt.Desktop.getDesktop().browse(new java.net.URI("https://sky.shiiyu.moe"))
    }
})
.addButton({
    category: "General",
    ...
    subcategory: "General",
    onClick() {
        java.awt.Desktop.getDesktop().browse(new java.net.URI("https://plancke.io"))
    }
})
.addButton({
    category: "General",
    ...
    subcategory: "General",
    onClick() {
        ChatLib.command("bombo editguis", true)
    }
})
.addButton({
    category: "UI",
...
const setting = new Settings("bombo", config, schemePath)
